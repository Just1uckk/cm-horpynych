...
var _userWeeklyLimitService = require("../userWeeklyLimitService ");
class CashOutNaturalService {
  ...
  getCommission() {
    ...
    const limit = new _userWeeklyLimitService.UserWeeklyLimitService(user, this.transfer.date, this.config.week_limit.amount).currentLimit();
