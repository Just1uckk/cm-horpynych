...
class CashOutNaturalService {
  constructor(transfer) {
    this.config = _modelState.ModelState.get(_constants.SITUATION_MODEL.cashOutNatural);
  ...
  getCommission() {
    ...
    const limit = new _userService.UserService(user, this.transfer, this.config.week_limit.amount).currentLimit();
